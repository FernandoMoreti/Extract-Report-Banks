...
export class NovosaqueExtractor extends Bank {
    ...
    async Navigate() {
        ...
        try {
            ...
            await this.page?.locator('#filter_date_type').selectOption('payment_date_local');
            ...
            const semRegistros = this.page?.getByText('Nenhum registro encontrado');
